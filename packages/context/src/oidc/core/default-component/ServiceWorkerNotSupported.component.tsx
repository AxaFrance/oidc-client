...
const ServiceWorkerNotSupported = () => (
  <div className="oidc-serviceworker">
    <div className="oidc-serviceworker__container">
      ...
      <p className="oidc-serviceworker__content">Votre navigateur n'est pas assez sécurisé pour faire fonctionner l'authentification. Essayer de mettre à jour votre navigateur ou utiliser un navigateur plus récent.</p>
    </div>
  </div>
);
